...
public class VariableExample2 {
	public static void main(String[] args) {
		 ...
		 * 할당된 공간을 byteNuber라고 부르겠다.
		 * 선언된 byteNumber 변수에 처음으로 127을 넣음
		 * --> 초기화 : 처음 변수에 값을 대입*/
		byte byteNumber = 127; //-128 ~ 127 -> 128 값 넣을 경우 에러
		
		System.out.println("byteNumber : " + byteNumber);
		
		/*************************************************************/
		
		short shortNumber = 32767; // ~ 32767 -> 32768 값 넣을 경우 에러
		
		// 정수 자료형 기본형(short, byte는 옛날 코드 잔재)!
		
	    /* 자료형 변수명 = 리터럴;
	     * 
	     * 프로그래멩에서는 대입되는 이 데이터(값 자체)를 리터럴이라는 단어로도 표현합니다!
	     * */
		int intNumber = 2147483647; // ~2147483647 -> 2147483648값 넣을 경우 에러
		 ...
		 * 
		 * The literal 10000000000 of type int is out of range  : int type
		 * -> 100억 이라는 값은 int의 범위를 벗어났다! 20억 몇까지만 가능..
		 *    뒤에 L을 붙여줌으로서 long 자료형인 것을 나타냄.
		 * */
		 ...
		 * 
		 * Type mismatch: cannot convert from double to float : double 값을 float에 집어넣어서 오류
		 * -> 1.2345까지만 쓰면 에러남(double 자료형이라서).
		 * */
	    ...
	    // 2. 예약어 사용 x
	    // double double; double int; double static;......
	    ...
	    int int_Number; // 자바는 카멜표기법 사용(_ 작성표기법은 DB에서 사용 : NUMBER_NAME)
	    ...
	    System.out.println(1 + 1.3); // 정수 + 실수 X -> 실수 + 실수 = 1.0 + 1.3 = 2.3 로 해석
	}
}
