...
public class SetService {
	...
	public void method2() {
		...
		/* boolean Iterator.hasNemt() : 
		 * 다음 순차 접근할 요소가 있으면 true, 없으면 flase
		 * */
	 ...
	 * -> 기본 오름차순 정렬
	 * * 전제존건 : 저장되는 객체는 Comparable 인터페이스 상속 필수!
	 ...
	 * </pre>
	 */
	public void lottoNumberGenertor() {
		...
		for(int i = 0; i < (money/1000); i++) {
			...
			list.add(lotto); // list에 Set 추가(담기)
			/* -> 반복 시 마다
			 * List각 인덱스에 서로 다른 Set 참조 주소가 저장된다.
			 * */
			
			System.out.println((i+1) + "회 : " + list.get(i));
		}
	}
}
