...
public class JavaAPIService {
	...
	public void method1() { 
		 ...
		 * */
		// Integer wap1 = new Integer(num1);
		
		Integer wrap1 = num1; 
		/* 컴파일러가 Auto Boxing 수행 코드 추가
		 * (int) num1 -> (Integer) num1
		 * */
		
		int num2 = wrap1;
		/* 컴파일러가 Auto Unboxing 수행 코드 추가
		 * (Integer) wrap1 -> (int) wrap1에 저장된 값
		 * */
		
		long num3 = 10_000_000_000L; // 100
	 ...
	 * - 문자열이 수정되면 새로 String 객체가 생성됨
	 */
	public void method3() {
		
		/* System.identityHashCode(str) 
		 * -> 주소 값을 이용해서 만든 해시코드(식별번호)
		 * -> 같은 객체에 저장된 값이 변햣다면 주소는 일정햐 된다!
	 ...
	 *   추가적으로 객체를 생성하지 않고
	 *   기존에 존잰하는 String 객체의 주소를 반환(재활용)
	 */
	public void method4() {
