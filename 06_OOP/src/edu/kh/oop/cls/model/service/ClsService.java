...
// extends Student : Student(부모)를 상속받음
public class ClsService /*extends Student*/ {
	...
	public void ex2() {
		...
		/* The static field Student.schoolNme should be accessed in a static way
		 * 
		 * schoolName에 노란줄이 뜨는 이유(경고) ==> 제대로 작성을 안해서
		 */
		System.out.println(std1.schoolName);
		
		// *** static이 붙은 필드(변수)는 '클래스.변수명'으로 사용함 ***
