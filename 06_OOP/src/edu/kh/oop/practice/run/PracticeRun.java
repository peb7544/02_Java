...
public class PracticeRun {
	 ...
	 * 
	 * class : 객체의 속성과 기능에 대한 정의흘 하는 것(설계도)
	 * 
	 * new 연산자 : new 연산자를 이용하면 Heap 메모리 영역에 객체가 생성
	 * 
	 * 추상화 : 공통점만 추출하고, 불필요한 부분 제거하는 과정
	 * 
	 * 캡슐화 : 속성과 기능을 하나로 묶어 관리하며, 데이터의 직접근제한을 원칙으로 함.
	 ...
	 * 
	 * 메서드/기능의 정의란 : 해당 메서드가 어떤 기능을 수행/실행할 것인지 작성(정의)하는 것.
	 * 
	 * 메서드의 호출이란 : 정의된 메서드의 내용대로 수행/실행할 수 있도록 메서드명을 부르는 것.
