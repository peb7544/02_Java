...
public class ServerService {
	 ...
	 * 
	 * - 하나의 포트에는 하나의 ServerSoket만 연결 가능
	 * */
	...
	public void serverStart() {
		...
		try {
			...
			clientSocket = serverSocket.accept(); // accpt : 수락하다
			 ...
			 * */
			Date now = new Date(); /* java.util.Date : 자방서 시간을 나타내는 객체
			...
			System.out.print("클라이언트로로 전달한 메세지 : ");
			String str2 = sc.nextLine();
			
			pw.println(str2); // 메시지를 서버쪽으로 출력
