...
public class ExceptionService {
	 ...
	 * 
	 * 예외는 두 종류로 구분됨
	 * 1) Unckecked Exception : 선택적으로 예외 처리(ex. Runtiom Exception..)
	...
	public void ex2() {
		...
		try {
			...
			int num2 = sc.nextInt(); // ArithmeticException
	...
	public void ex3() {
		...
		try {
			...
			System.out.println("결과 : " + num1 / num2); // NullPointerException
		} catch(ArithmeticException e) {
	...
	public void methodA() /* 7) */ throws IOException {
		/* 2) */ methodB();
	}
	
	public void methodB() /* 6) */ throws IOException {
		/* 3) */ methodC();
	}
	
	public void methodC() /* 5) */ throws IOException {
