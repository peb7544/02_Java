package adu.kh.io.pack1.model.service;
...
public class FileService {
	...
	public void method1() {
		...
		File directory = new File("C:/io_test/20240222");
	...
	public void method3() {
		...
		for( File f : files) {
			...
			// System.out.println(f.toString()); // \workspace\02_JAVA\12_io\.classpath
			...
			// System.out.println(lastModified); // 1708571639564
